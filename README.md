...
1. The default search results for the details will show for Batman. This is because I did not have time to determine how to handle the case of no search results, such as when you type a search result that does not give an answer
